...
int main(){
    ...
    printf("Bispo e Torre estarão se movimentando apenas para direita e a Rainha para a esquerda por enquanto.\n");
    printf("--------------------------\n");    
    
    // Solicitar informações para o jogador
    printf("Escolha a peça que irá movimentar:\n");
    printf("Digite B para Bispo, R para Rainha e T para Torre:\n");
    scanf("%c", &peca);
